...
describe("before_dispatch hook", () => {
  ...
  it("uses canonical hook metadata and shared routed final delivery", async () => {
    ...
    const ctx = createHookCtx({
      ...
      MediaPath: "/tmp/report.xlsx",
      MediaPaths: ["/tmp/report.xlsx"],
      MediaUrl: "https://example.test/report.xlsx",
      MediaUrls: ["https://example.test/report.xlsx"],
