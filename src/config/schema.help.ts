...
export const FIELD_HELP: Record<string, string> = {
  ...
  "plugins.entries.*.hooks.allowConversationAccess":
    "Controls whether this plugin may read raw conversation content from typed hooks such as `before_agent_run`, `before_model_resolve`, `before_agent_reply`, `llm_input`, `llm_output`, `before_agent_finalize`, `agent_end`, and `model_failure_terminal`. Non-bundled plugins must opt in explicitly.",
