...
export const id: TranslationMap = {
  ...
  agents: {
    noAgents: "Tidak ada agen",
    copyId: "Salin ID",
    copyIdTitle: "Salin ID agen ke clipboard",
    default: "Default",
    setDefault: "Jadikan Default",
    alreadyDefaultTitle: "Sudah menjadi agen default",
    setDefaultTitle: "Jadikan sebagai agen default",
    selectTitle: "Pilih agen",
    selectSubtitle: "Pilih agen untuk memeriksa ruang kerja dan alatnya.",
    tabs: {
      overview: "Ikhtisar",
      files: "File",
      tools: "Alat",
    ...
    context: {
      ...
      openFilesTab: "Buka tab File",
      primaryModel: "Model Utama",
      runtime: "Runtime",
      identityName: "Nama Identitas",
      identityAvatar: "Avatar Identitas",
      skillsFilter: "Filter Skills",
      default: "Default",
      configurationSubtitle: "Konfigurasi ruang kerja, identitas, dan model.",
      schedulingSubtitle: "Target ruang kerja dan penjadwalan.",
    },
    channels: {
      title: "Saluran",
      subtitle: "Snapshot status saluran di seluruh Gateway.",
      lastRefresh: "Pembaruan terakhir: {time}",
      loadHint: "Muat saluran untuk melihat status langsung.",
      empty: "Tidak ada saluran ditemukan.",
      connectedCount: "{connected}/{total} terhubung",
      noAccounts: "tidak ada akun",
      configuredCount: "{count} dikonfigurasi",
      notConfigured: "belum dikonfigurasi",
      enabledCount: "{count} diaktifkan",
      setupGuide: "Panduan penyiapan",
    },
    cronPanel: {
      schedulerTitle: "Penjadwal",
      schedulerSubtitle: "Status cron Gateway.",
      jobs: "Tugas",
      nextWake: "Bangun berikutnya",
      agentJobsTitle: "Tugas Cron Agen",
      agentJobsSubtitle: "Tugas terjadwal yang menargetkan agen ini.",
      noJobs: "Tidak ada tugas yang ditetapkan.",
      runNow: "Jalankan Sekarang",
    },
    files: {
      emptyDraft: "Draf kosong",
      minRead: "{count} menit baca",
      markdownPreview: "Pratinjau Markdown",
      extensionPreview: "Pratinjau {ext}",
      preview: "Pratinjau",
      expandPreview: "Perluas pratinjau",
      collapsePreview: "Ciutkan pratinjau",
      editFile: "Ubah file",
      closePreview: "Tutup pratinjau",
      coreFilesTitle: "File Inti",
      coreFilesSubtitle: "Panduan persona, identitas, dan alat awal.",
      workspace: "Ruang kerja",
      loadHint: "Muat file ruang kerja agen untuk mengedit instruksi inti.",
      empty: "Tidak ada file ditemukan.",
      missing: "hilang",
      selectFile: "Pilih file untuk diedit.",
      previewMarkdownTitle: "Pratinjau markdown yang dirender",
      willCreateOnSave: "Akan Dibuat Saat Disimpan",
      liveDraftPreview: "Pratinjau Draf Langsung",
      savedPreview: "Pratinjau Tersimpan",
      updated: "Diperbarui {time}",
      notCreatedYet: "Belum Dibuat",
      updatedUnknown: "Pembaruan Tidak Diketahui",
      missingHint: "File ini hilang. Menyimpan akan membuatnya di ruang kerja agen.",
      content: "Konten",
      words: "{count} kata",
      lines: "baris",
    },
  ...
  debug: {
    ...
    snapshotsSubtitle: "Data status, kesehatan, dan heartbeat.",
    status: "Status",
    health: "Kesehatan",
    ...
    security: {
      ...
      noCriticalIssues: "Tidak ada masalah kritis",
      info: "{count} info",
      runPrefix: "Jalankan",
      runSuffix: "untuk detail.",
    },
    manualRpcTitle: "RPC Manual",
    manualRpcSubtitle: "Kirim metode gateway mentah dengan parameter JSON.",
    method: "Metode",
    selectMethod: "Pilih metode…",
    paramsJson: "Parameter (JSON)",
    modelsTitle: "Model",
    modelsSubtitle: "Katalog dari models.list.",
    eventLogTitle: "Log Peristiwa",
    eventLogSubtitle: "Peristiwa Gateway terbaru.",
    noEvents: "Belum ada peristiwa.",
  },
  execApproval: {
    expiresIn: "kedaluwarsa dalam {time}",
    expired: "kedaluwarsa",
    execApprovalNeeded: "Persetujuan exec diperlukan",
    pluginApprovalNeeded: "Persetujuan plugin diperlukan",
